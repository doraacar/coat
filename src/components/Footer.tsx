      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold mb-4">ProCoat Solutions</h3>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/90">info@procoatsolutions.com</span>
              </div>
              <div className="flex items-center gap-3">
      ...
      <div className="border-t border-white/20 bg-primary-dark">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-white/60">
            <p>
              © {currentYear} ProCoat Solutions. All rights reserved. | 
